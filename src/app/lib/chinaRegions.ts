...
export const CHINA_REGIONS = {
  ...
  "青海省": {
    ...
    "自治州": ["门源回族自治县", "祁连县", "海晏县", "刚察县", "同仁市", "尖扎县", "泽库县", "河南蒙古族自治县", "共和县", "同德县", "贵德县", "兴海县", "贵南县", "玛沁县", "班玛县", "甘德县", "达日县", "久治县", "玛多县", "玉树市", "杂多县", "称多县", "治多县", "囊谦县", "曲麻莱县", "格尔木市", "德令哈市", "茫崖市", "乌兰县", "都兰县", "天峻县", "大柴旦行政委员会"]
  },
  "宁夏回族自治区": {
  ...
  "台湾省": {
    ...
    "高雄市": ["楠梓区", "左营区", "鼓山区", "三民区", "盐埕区", "前金区", "新兴区", "苓雅区", "前镇区", "旗津区", "小港区", "凤山区", "林园区", "大寮区", "大树区", "大社区", "仁武区", "鸟松区", "冈山区", "桥头区", "燕巢区", "田寮区", "阿莲区", "路竹区", "湖内区", "茄萣区", "永安区", "弥陀区", "梓官区", "旗山区", "美浓区", "六龟区", "甲仙区", "杉林区", "内门区", "茂林区", "桃源区", "那玛夏区"],
    "基隆市": ["中正区", "七堵区", "暖暖区", "仁爱区", "中山区", "安乐区"],
    "新竹市": ["东区", "北区", "香山区"],
    "嘉义市": ["东区", "西区"],
    "新竹县": ["竹北市", "竹东镇", "新埔镇", "关西镇", "湖口乡", "新丰乡", "芎林乡", "横山乡", "北埔乡", "宝山乡", "峨眉乡", "尖石乡", "五峰乡"],
    "苗栗县": ["苗栗市", "头份市", "苑里镇", "通霄镇", "竹南镇", "后龙镇", "卓兰镇", "大湖乡", "公馆乡", "铜锣乡", "南庄乡", "头屋乡", "三义乡", "西湖乡", "造桥乡", "三湾乡", "狮潭乡", "泰安乡"],
    ...
    "台东县": ["台东市", "成功镇", "关山镇", "卑南乡", "鹿野乡", "池上乡", "东河乡", "长滨乡", "太麻里乡", "大武乡", "绿岛乡", "兰屿乡", "延平乡", "海端乡", "达仁乡", "金峰乡"],
  ...
  "澳门特别行政区": {
    "澳门": ["花地玛堂区", "圣安多尼堂区", "大堂区", "望德堂区", "风顺堂区", "嘉模堂区", "圣方济各堂区", "路氹城", "澳门新城"]
  }
} as const;
...
export const COUNTRIES = [
  "中国",
  "美国", "加拿大", "英国", "法国", "德国", "意大利", "西班牙", "葡萄牙", "荷兰", "比利时", "瑞士", "瑞典", "挪威", "丹麦", "芬兰", "奥地利", "希腊", "波兰", "捷克", "匈牙利", "罗马尼亚", "保加利亚", "克罗地亚", "塞尔维亚", "乌克兰", "俄罗斯",
  "日本", "韩国", "新加坡", "马来西亚", "泰国", "越南", "印度尼西亚", "菲律宾", "印度", "巴基斯坦", "孟加拉国", "斯里兰卡", "尼泊尔", "缅甸", "柬埔寨", "老挝", "文莱", "马尔代夫",
  "澳大利亚", "新西兰", "斐济", "巴布亚新几内亚",
  "巴西", "阿根廷", "智利", "秘鲁", "哥伦比亚", "委内瑞拉", "厄瓜多尔", "乌拉圭", "巴拉圭", "玻利维亚",
  "墨西哥", "古巴", "牙买加", "海地", "多米尼加", "危地马拉", "洪都拉斯", "萨尔瓦多", "尼加拉瓜", "哥斯达黎加", "巴拿马",
  "埃及", "南非", "尼日利亚", "肯尼亚", "埃塞俄比亚", "坦桑尼亚", "乌干达", "阿尔及利亚", "摩洛哥", "突尼斯", "利比亚", "苏丹", "加纳", "安哥拉", "莫桑比克", "马达加斯加", "喀麦隆", "科特迪瓦", "尼日尔", "布基纳法索", "马里", "马拉维", "赞比亚", "塞内加尔", "索马里", "乍得", "几内亚", "卢旺达", "贝宁", "布隆迪", "南苏丹",
  "沙特阿拉伯", "伊朗", "伊拉克", "以色列", "土耳其", "阿联酋", "卡塔尔", "科威特", "巴林", "阿曼", "约旦", "黎巴嫩", "叙利亚", "也门", "阿富汗", "阿塞拜疆", "亚美尼亚", "格鲁吉亚", "哈萨克斯坦", "乌兹别克斯坦", "土库曼斯坦", "吉尔吉斯斯坦", "塔吉克斯坦", "蒙古",
  "其他"
] as const;